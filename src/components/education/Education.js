...
// }, [data1]);
  ...
  return (
    ...
    <p className="display-4 text-center mt-5">Education</p>
      {err.length !== 0 && <p className="text-danger display-3 text-center ">{err}</p>}
      <div className='row mt-5'>
        <div className='col-10 col-sm-8 col-md-6 mx-auto my-auto'>     
          <form onSubmit={handleSubmit(addnewData)} className='mx-auto my-auto'>
            <div >
